...
const Login = () => {
    ...
    return (
        <>
            <div className="min-h-[calc(100vh-128px)] flex-1 flex items-center justify-center bg-slate-50">
                {isLoanding ? (
                    <Spinner />
                ) : (
                    <div className="px-5  py-3 border bg-white border-slate-200 rounded-xl overflow-hidden min-w-[400px]">
                        ...
                        >
                            ...
                            <input
                                type="submit"
                                className="text-white bg-primary mt-4 w-full rounded-2xl py-1 cursor-pointer"
                                value={"Login"}
                            />
                            ...
                            <Link className="w-full" to={"/signup"}>
                                <button className="text-primary hover:bg-gray-600/10 hover:text-gray-700  border-2 border-primary block  w-[200px] mx-auto rounded-2xl py-1 cursor-pointer">
                                    Sign up
                                </button>
                            </Link>
                        </form>
