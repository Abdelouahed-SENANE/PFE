...
const Paginate = ({ totalPage , prevPage , nextPage , currentPage}) => {

    return (
        <div className="py-5 px-3 flex items-center justify-between bg-white border-t-0 border w-full rounded-es-lg rounded-ee-lg">
            <div className="flex items-center gap-2 justify-between w-full">
                ...
                <div className="text-gray-600 text-sm">
                    ...
                    <span className="text-black">{totalPage}</span>
                </div>
            </div>
        </div>
    );
